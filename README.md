...
*[yw.jar](yw.jar) is a standalone executable jar-file (created with the maven goal '`package`') for quick experimenting without having to compile the project oneself*
